...
export const TVFloatingControlBar: React.FC<TVFloatingControlBarProps> = ({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-3xl px-4 pointer-events-auto select-none animate-scale-in">
      {/* Floating VisionOS Glass Pill Bar (Clean & Minimal matching Reference Image) */}
      <div className="glass-pill-bar px-6 py-3 rounded-full flex items-center justify-between shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
