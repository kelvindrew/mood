...
export const TVLobbyView: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen pt-20 px-[5vw] pb-16 select-none flex flex-col justify-between bg-[#07090E]">
      ...
      <div className="relative z-10 flex items-center justify-between border-b border-white/10 pb-4">
        <div className="flex items-center space-x-4">
          <button
            ...
            className="flex items-center space-x-2 px-5 py-3 rounded-2xl bg-[#101420] border-2 border-white/15 text-white hover:text-white focus:bg-white focus:text-black focus:ring-4 focus:ring-white transition-all outline-none"
          >
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="px-3 py-0.5 rounded-full bg-gradient-to-r from-[#E50914] to-[#FF2E63] text-white text-[11px] font-black uppercase tracking-wider shadow-md">
                SALON MULTIJOUEUR
              </span>
              <span className="text-[#B8C2D8] text-xs font-bold">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex flex-col items-end">
            <span className="text-[10px] font-black text-[#B8C2D8] tracking-widest uppercase">CODE DU SALON</span>
            <div className="px-8 py-2.5 rounded-2xl bg-[#101420] text-[#FFB800] font-mono font-black text-4xl tracking-widest shadow-[0_0_30px_rgba(255,184,0,0.4)] border-2 border-[#FFB800]/50">
              {room.code}
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 my-auto py-6">
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center p-8 rounded-3xl bg-[#101420] border-2 border-white/15 shadow-2xl space-y-5">
          <div className="text-center">
            <span className="text-[#00F2FE] text-xs font-black tracking-widest uppercase flex items-center justify-center space-x-1.5">
            ...
            <p className="text-xs text-[#B8C2D8] mt-1 max-w-xs leading-relaxed font-medium">
              Visez le QR Code pour transformer immédiatement votre smartphone en manette.
            </p>
          </div>

          {/* Ultra-sharp High-Contrast QR Code */}
          <div className="p-4 rounded-3xl bg-white shadow-[0_0_35px_rgba(0,242,254,0.3)] border-4 border-[#00F2FE]">
            <QRCodeSVG
              value={mobileJoinUrl}
              size={210}
              level="H"
          ...
          <div className="w-full flex flex-col items-center space-y-2">
            <div className="flex items-center space-x-2 text-xs text-gray-200 bg-[#07090E] px-4 py-2.5 rounded-xl border border-white/10 shadow-inner">
              <span className="text-[#B8C2D8] font-bold">Site :</span>
              <span className="font-mono text-[#00F2FE] font-black truncate max-w-[260px]">
                {typeof window !== 'undefined' ? window.location.host : 'mood.kalvinec.workers.dev'}
              </span>
            </div>
            <div className="text-xs text-[#B8C2D8] flex items-center space-x-2 pt-1 font-bold">
              <span>Code du salon :</span>
              <span className="text-[#FFB800] font-mono text-2xl font-black px-4 py-1 rounded-xl bg-[#07090E] border border-[#FFB800]/40 shadow-sm">
                {room.code}
              </span>
            </div>
          </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-between p-8 rounded-3xl bg-[#101420] border-2 border-white/15 shadow-2xl space-y-6">
          <div>
          ...
          <div className="flex items-center justify-between pt-6 border-t border-white/10">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="flex items-center space-x-3 px-10 py-4 rounded-2xl bg-gradient-to-r from-[#10B981] to-[#059669] text-white font-black text-xl shadow-[0_0_35px_rgba(16,185,129,0.5)] transition-all duration-200 outline-none
                           focus:scale-105 focus:bg-white focus:text-[#059669] focus:ring-4 focus:ring-white"
              >
      ...
      {countdown !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90">
          <div className="flex flex-col items-center space-y-4 animate-scale-in">
            <span className="text-xl font-bold text-[#FFB800] tracking-widest uppercase">
              La partie commence dans
            </span>
            <span className="text-9xl font-black font-display text-white animate-pulse drop-shadow-[0_0_40px_rgba(229,9,20,0.8)]">
              {countdown}
            </span>
